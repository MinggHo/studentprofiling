<?php
  ...
  $markah_ber = $markah['data'][3];
  $markah_eks = $markah['data'][4];
  $markah_int = $markah['data'][5];
  $markah_itr = $markah['data'][6];
  ...
  $sql = "INSERT INTO skor_markah VALUES (NULL, '$kadmatrik', CURRENT_TIMESTAMP, '$markah_agg', '$markah_ana', '$markah_aut', '$markah_ber', '$markah_eks', '$markah_int', '$markah_itr', '$markah_kep', '$markah_ket', '$markah_kri', '$markah_mng', '$markah_mnl', '$markah_skg', '$markah_str', '$markah_pcp', '$markah_kjj')";
